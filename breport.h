...
/*!
  ...
  @note Por definición, el primer valor de la lista de datos se refiere al directorio
...
protected:
    ...
    /*!
      ...
      @return Tabla a�adida para modificarla si fuera necesario
    ...
    /*!
      A�ade una linea resaltada al documento, del tipo negrita: texto
    ...
    /*!
      ...
      @param fontSize   Tamaño de fuente del titulo
      @note Modifica el documento y el cursor
      */
